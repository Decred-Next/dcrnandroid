...
package com.dcrnandroid.dialog.txdetails
...
import com.dcrnandroid.BuildConfig
...
import com.dcrnandroid.extensions.toggleVisibility
        ...
        when (v!!.id) {
            ...
            R.id.view_dcrdata -> {
                val url = if (BuildConfig.IS_TESTNET) {
                    ...
                    "https://data.dcrn.xyz/tx/" + transaction.hash
                }
